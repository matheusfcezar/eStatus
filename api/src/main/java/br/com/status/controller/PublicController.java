...
import br.com.status.service.TJService;
...
public class PublicController {
	...
	public ResponseEntity<Andamento> testeDownload(@RequestParam String numeroProcesso) {
		Andamento andamento = tjService.salvarAtualizacao(numeroProcesso);
			
		return andamento != null ? ResponseEntity.ok(andamento) : ResponseEntity.notFound().build();
	}
